...
[**Download Ration 0.7.3**](https://github.com/mcpeixoto/ration/releases/latest/download/Ration-0.7.3.dmg)
...
`ration-0.7.3-linux-x86_64.tar.gz` (or `aarch64` on ARM).

```sh
tar -xzf ration-0.7.3-linux-x86_64.tar.gz
cd ration-0.7.3-linux-x86_64
